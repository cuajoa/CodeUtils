...
DECLARE @NumCuotapartista	NumeroLargo = 2000006775
DECLARE @NumFondo	NumeroLargo = 3
DECLARE @FechaDesde         Fecha ='20200413'
DECLARE @FechaHasta         Fecha ='20200414'
...
SELECT  @CodFondo = CodFondo FROM FONDOSREAL WHERE NumFondo = @NumFondo	
...
SELECT SUM(#SOLICITUDES.Resultado) as Importe, 
	   (SUM(#SOLICITUDES.ImporteFinal)/SUM(#SOLICITUDES.ImporteDia)) *100 as Porcentaje, 
	   MONEDAS.Simbolo
FROM #SOLICITUDES
